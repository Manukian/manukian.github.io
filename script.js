window.onload = function() {
    ...
    var borderTouch = window.innerHeight*0.5;
    var margkTouch = 0.55;
    ...
    var touchanimate = function(e) {
        ...
        onetozero = Math.abs((touch.clientY/(window.innerHeight-borderTouch))-1);
        margintop = Math.abs((touch.clientY/(window.innerHeight))-1)*margtopk;
        scale = onetozero;
        rotate = onetozero*45;
        linkcolor = touch.clientY/(window.innerHeight-borderTouch);
        wrap.style.transform = 'rotateX(' + x + 'deg) rotateY(' + y + 'deg)';
